...
def basic_training_parameters(parser):
    ...
    parser.add_argument('--evaluation_metrics', nargs='+',
                        default=['e_recall@1', 'e_recall@5', 'e_recall@10', 'nmi', 'f1', 'mAP_1000', 'mAP_lim', 'mAP_c', \
...
def wandb_parameters(parser):
    ...
    parser.add_argument('--wandb_key',       default='Your_Key',  type=str,   help='API key for W&B.')
...
def LSD_training_parameters(parser):
    parser.add_argument('--kd_tau', default=1.0, type=float, help='temperature param tau.')
    parser.add_argument('--kd_alpha', default=200.0, type=float, help='kd-loss weight param alpha.')
...
def noisy_label_parameters(parser):
    parser.add_argument('--noisy_label', action='store_true',
                        help='Flag. If set, use noisy labels.')
    parser.add_argument('--noisy_ratio', default=0.0, type=float, help='The proportion of noisy samples in the training set.')
    return parser
