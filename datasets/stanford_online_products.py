...
from datasets.basic_dataset_scaffold_noisy import BaseDataset as BaseDataset_noisy
...
def Give(opt, datapath):
    ...
    if opt.noisy_label:
        print('Preparing noisy label for training set ...')
        train_dataset = BaseDataset_noisy(train_image_dict, opt)
    else:
